...
class FilterProductionBottomSheet extends StatefulWidget {
  const FilterProductionBottomSheet({super.key});

  @override
  State<FilterProductionBottomSheet> createState() => _FilterProductionBottomSheetState();
}

class _FilterProductionBottomSheetState extends State<FilterProductionBottomSheet> {
        ...
        child: Column(
          ...
          children: [
            CommonBottomSheetHeader(
              ...
              title: "Filter Production",
              subtitle: "Select Production statuses to filter",
