...
import '../visit_area_customer/bloc/visit_area_customer_list_state.dart';


class AreaWiseCustomerScreen extends StatefulWidget {
  final String branchId;
  final String visitAreaId;


  const AreaWiseCustomerScreen({
    required this.branchId,
    required this.visitAreaId,
    super.key,});

  @override
  State<AreaWiseCustomerScreen> createState() => _AreaWiseCustomerScreenState();
}

class _AreaWiseCustomerScreenState extends State<AreaWiseCustomerScreen> {
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context)=> VisitAreaCustomerListBloc(),
      child: AreaWiseCustomer(
        branchId: widget.branchId,
        visitAreaId: widget.visitAreaId,
      ),
    );
  }
}
...
class AreaWiseCustomer extends StatefulWidget {
  final String branchId;
  final String visitAreaId;
  ...
  @override
  State<AreaWiseCustomer> createState() => _AreaWiseCustomerState();
}

class _AreaWiseCustomerState extends State<AreaWiseCustomer> {
