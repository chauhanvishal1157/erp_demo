...
class DispatchHistoryBottomSheet extends StatefulWidget {
  ...
  const DispatchHistoryBottomSheet({
  ...
  @override
  State<DispatchHistoryBottomSheet> createState() => _DispatchHistoryBottomSheetState();
}

class _DispatchHistoryBottomSheetState extends State<DispatchHistoryBottomSheet> {
