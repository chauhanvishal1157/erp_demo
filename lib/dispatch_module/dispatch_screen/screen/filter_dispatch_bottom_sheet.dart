...
class FilterDispatchBottomSheet extends StatefulWidget {
  const FilterDispatchBottomSheet({super.key});

  @override
  State<FilterDispatchBottomSheet> createState() => _FilterDispatchBottomSheetState();
}

class _FilterDispatchBottomSheetState extends State<FilterDispatchBottomSheet> {

  bool isAllSelected = true;

  Map<String, bool> statusMap = {
    "Order Dispatch": false,
        ...
        child: Column(
          ...
          children: [
            CommonBottomSheetHeader(
              ...
              title: "Filter Orders",
              subtitle: "Select Dispatch statuses to filter",
